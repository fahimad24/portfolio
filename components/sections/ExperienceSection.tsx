                ...
                {education.map((edu, i) => (
                  ...
                  >
                    ...
                    <div className="glow-card flex-1 p-7">
                      ...
                      <div className="lg:flex flex-wrap justify-between items-center gap-2 mb-2">
                        <p className="text-[0.9rem] text-accent-3 mb-3 font-medium">
                          {edu.institution}
                        </p>
                        <span
                          className="text-[0.8rem] font-['JetBrains Mono'] text-accent px-3 py-0.5 rounded-full lg:block"
                          style={{
                            background: "rgba(108,99,255,0.1)",
                            border: "1px solid rgba(108,99,255,0.2)",
                          }}
